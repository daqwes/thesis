...
[yhat,As,rho_true,n_meas] = problem_gen(matrix_type,n,ns_i,seed);
% yhat
% quit
[Y_rho_r_record,t_rec,norm_rec] = Langevin_sampler(yhat,As,r,n,n_meas,iter,alpha,lambda_i,theta,beta,eta_i,seed);
M_avg = mean(Y_rho_r_record(:,:,end-1000:end),3);
