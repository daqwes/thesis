...
We usually talk about \textit{convergence} when the samples come from $\pi$ (the posterior distribution we want to sample from), or that the Markov chain has \textit{mixed} (based on a visual assessment for example). A pseudocode for the algorithm could be:\medbreak
