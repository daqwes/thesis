...
One might also wonder if this is related to the parameter $\theta$ in the prior. In this case, we ran the same experiment with $\theta \in \{1\text{e-}6,1\text{e-}3,1\text{e-}2,1\text{e-}1,1\text{e}0, 1\text{e}1\}$:
...
In an effort to to answer the question: ``'', we introduce 2 new algorithms
\subsection*{Metropolis-Hastings with Gibbs with Student-t prior}

\section{Proposal choice}\label{section:proposal-choice}

\section{Numerical comparison}\label{section:mhs-mhgs-num-exp}
