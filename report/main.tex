...
In this chapter, we will start by introducing more formally the problem of Quantum Tomography, describe existing methods to tackle it and state the contribution of this thesis.\medbreak

In Chapter 2, we will provide the needed background to understand QT in the context of numerical experiments, as well as an introduction to Markov chain Monte Carlo methods, with an emphasis on the methods relevant for this thesis.

In Chapter 3, we will review in detail the 2 main algorithms used in the numerical experiments in the context of this work.

In Chapter 4, we will first compare both of the algorithms in terms of their accuracy and versatility, and second we will introduce 2 new algorithms to better understand how their choice and structure impacts the accuracy.
...
We will now focus on the main contribution of this thesis, namely numerical experiments to commpare the prob-estimator (which we will refer to as prob) and the Projected Langevin algorithm (which we will refer to as PL).
