...
The main motivation behind this approach comes from the faster convergence times, especially in high-dimensional settings where Metropolis-Hastings suffers. The proposed prior allows for a computable gradient, which bootstraps the use of Langevin sampling.\medbreak
...
Note that there are some elements that do not match for the prob-estimator between the paper and the implementation:
\begin{itemize}
